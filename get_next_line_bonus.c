...
/*   Updated: 2025/02/19 04:02:57 by dimachad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line_bonus.h"

static char	*ft_split(char **in_str, char **split_str, ssize_t splt_pt)
{
	char	*temp_str;
	ssize_t	len;
...
static char	*ft_strjoin(char *str_1, char *str_2)
{
	char	*joined_str;
	ssize_t	len_1;
	ssize_t	len_2;
...
static char	*read_until_new_ln_or_eof(t_fd_nd **fd_nd, char **line_buf)
{
	char	*read_buff;
...
static char	*build_ln(t_fd_nd **fd_nd, t_fd_nd **fd_head, char **line_buf)
{
	while (1)
	{
